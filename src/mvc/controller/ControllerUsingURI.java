...
public class ControllerUsingURI extends HttpServlet {
	...
	private void process(HttpServletRequest request, HttpServletResponse response)
		...
		/*
		 * if (command.equals("/join.do")) { handler = new JoinHandler(); } else if
		 * (command.contentEquals("/login.do")) { handler = new LoginHandler(); } else
		 * if (command.equals("/logout.do")) { handler = new LogoutHandler(); } else {
		 * handler = new NullHandler(); }
		 */
